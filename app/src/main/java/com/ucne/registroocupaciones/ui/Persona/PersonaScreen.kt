...
fun PersonaScreen(
    ...
    val ocupaciones = listOf(
        Ocupation(ocupacionid = 1, descripcion = "Ingeniero", salario = 60000.00),
        Ocupation(ocupacionid = 1, descripcion = "Agricultor", salario = 60000.00),
        Ocupation(ocupacionid = 1, descripcion = "Pintor", salario = 60000.00),
        Ocupation(ocupacionid = 1, descripcion = "Maestro", salario = 60000.00),
    )
    Scaffold(
        topBar = {
