...
public final class PersonaDao_Impl implements PersonaDao {
  ...
  public PersonaDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPersona = new EntityInsertionAdapter<Persona>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `Personas` (`personaid`,`telefono`,`celular`,`email`,`direccion`,`fechanacimiento`,`nombres`,`ocupacionid`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
  ...
  @Override
  public Flow<List<Persona>> getList() {
