...
public abstract interface OcupacionDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM Ocupaciones WHERE id = :id")
    public abstract kotlinx.coroutines.flow.Flow<com.ucne.registroocupaciones.model.Ocupation> getOcupacion(int id);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM Ocupaciones")
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.ucne.registroocupaciones.model.Ocupation>> getAll();
}